...
Else
    If (RANGe = 0.1) Then
        Number = Number / 1000
    End If
    Dim DataOut1(1 To 17) As Byte
    Number = CStr(Format(Number, IIf(Number > 0, "+0.00000000E+00", "0.00000000E+00")))
     
    For I = 1 To 15
    DataOut1(I) = Asc(Mid(Number, I, 1))
    Next
    DataOut1(16) = 13
    DataOut1(17) = 10
    If FrmMain.MSComm.PortOpen = True Then FrmMain.MSComm.OutPut = DataOut1
    If FrmMain.MSComm1.PortOpen = True Then FrmMain.MSComm1.OutPut = DataOut1
End If
End If
errhdl: Exit Sub
End Sub
