...
Public Property Get Get34401ALearnString(myDevice As Agt3494ALib.Agt3494A) As String
    ...
    myDevice.Output "conf?"
    myDevice.Enter strConfig
    ...
    Then
        If InStr(strConfig, "VOLT:RAT") <> 1 Then
            ...
            myDevice.Output strFunction
            myDevice.Enter strReply 'will hold 0 or 1
    ...
    Then
        ...
        myDevice.Output strFunction
        myDevice.Enter strReply
        cleanString strReply

        strFunction = Left(strReply, Len(strReply) - 1) 'rid of '?'
    ...
    'calc offset
    myDevice.Output "calc:null:offset?"
    myDevice.Enter strReply
    cleanString strReply
    ...
    'limit lower
    myDevice.Output "calc:limit:lower?"
    myDevice.Enter strReply
    cleanString strReply
    ...
    'lim upper
    myDevice.Output "calc:lim:upper?"
    myDevice.Enter strReply
    cleanString strReply
    ...
    'trig delay auto
    myDevice.Output "trig:delay:auto?"
    myDevice.Enter strReply
    cleanString strReply
